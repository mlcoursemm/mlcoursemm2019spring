...
* Вторая [лекция](lec/lecture02.pdf), первое [теоретическое задание](assignments/theory01.pdf) (дедлайн для получения полного балла - 01 марта 2019) и [ноутбуки](prac/) со второго занятия
